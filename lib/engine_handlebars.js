...
Handlebars.registerHelper({
  ...
  'extend-attr': function(context1, context2) {
    return deepExtend(deepExtend(deepExtend({}, context1), context2), {'class': classnames(context1&&context1.class?context1.class:'', context2&&context2.class?context2.class:'')});
  }
});
